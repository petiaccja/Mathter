...
auto operator|(const Swizzle<VectorData1, Indices1...>& lhs, const Swizzle<VectorData2, Indices2...>& rhs) {
	using TS1 = typename traits::VectorDataTraits<VectorData1>::Type;
	using TS2 = typename traits::VectorDataTraits<VectorData2>::Type;	
...
auto operator|(const Swizzle<VectorData1, Indices1...>& lhs, const Vector<T2, Dim, Packed>& rhs) {
	using TS = typename traits::VectorDataTraits<VectorData1>::Type;
